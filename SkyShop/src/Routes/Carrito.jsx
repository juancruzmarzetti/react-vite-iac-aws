  ...
  const confirmarReserva = async () => {
    if (horaSeleccionada && fechaSeleccionada && direction.trim() !== "") {
      try {
        ...
        const responseCartId = await axios.get(`/api/carts/user/${loggedUser.id}`);
        ...
        const responseCart = await fetch(`/api/carts/${cartId}/items`, settings);
        ...
        const responseOrder = await fetch('/api/orders/create', settingsOrder);
